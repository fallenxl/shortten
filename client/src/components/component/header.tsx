...
export default function Header() {
  ...
  return (
    <nav
      className={`flex ${
        !user && "flex-col sm:flex-row"
      } gap-2 items-center justify-between pt-4 pb-10`}
    >
      <Link href="/">
      ...
      {!isLoading && !user && (
        <p className="sm:hidden text-gray-600 text-xs font-medium">
          Sign in with
        </p>
      )}
      <div
        className={`${
          !user && "w-full justify-center"
